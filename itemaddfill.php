	...
	<div class="main-content">
		...
		<div class="sticky-header header-section ">
			<div class="header-left">
				<!--logo -->
				<div class="logo">
					<a href="admin_dashboard.php"><h1>Add Item</h1></a>
								...
								<li class="dropdown profile_details_drop">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
										<div class="profile_img">	
											<span class="prfil-img"><h5><?= $username; ?></h5> <img src="assets\img\admin1.png" style="width:100px;height:50px;" alt=""></span> 
...
<?php if (isset($_GET['error'])): ?>
	...
	<?php endif ?>
     <form action="itemadd.php"
           ...
           <div>
           <div  style="height:50px"><h2 >Product Name   :<input type="text" name="name"></h2></div>
           <div  style="height:50px"><h2 >Product Price  :<input type="text" name="price"></h2></div>
            <div style="height:75px"><h2>Choose a Image :<input type="file" name="my_image"></h2></div>
            &emsp;&emsp;&emsp;     
